          ...
          <div className="p-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
              ...
              <div className={`text-center p-3 rounded-lg ${isDark ? "bg-white/5" : "bg-gray-50"}`}>
                ...
                <p className={`text-sm font-semibold ${isDark ? "text-white" : "text-gray-900"}`}>{course.level}</p>
              </div>
              <div className={`text-center p-3 rounded-lg ${isDark ? "bg-white/5" : "bg-gray-50"}`}>
            ...
            {/* Schedule */}
            <div className={`p-4 rounded-lg mb-6 text-center ${isDark ? "bg-[#f47822]/10" : "bg-orange-50"}`}>
              <p className="text-xs text-[#f47822] font-medium mb-1">Class Schedule</p>
              <p className={`text-sm font-semibold ${isDark ? "text-white" : "text-gray-900"}`}>{course.schedule}</p>
            </div>

            {/* Fee Information */}
            <div className={`p-4 rounded-lg mb-6 ${isDark ? "bg-[#f47822]/10 border border-[#f47822]/30" : "bg-orange-50 border border-[#f47822]/30"}`}>
              <h3 className={`text-lg font-bold text-center mb-4 ${isDark ? "text-[#f47822]" : "text-[#f47822]"}`}>
              ...
              <div className="text-center space-y-2">
                ...
                <p className={`text-xs ${isDark ? "text-white/60" : "text-gray-500"}`}>
                  Total Price • Payment Options Available
                </p>
                <div className={`pt-3 mt-3 border-t ${isDark ? "border-[#f47822]/30" : "border-[#f47822]/20"}`}>
                  <p className={`text-xs ${isDark ? "text-white/70" : "text-gray-600"}`}>
                    • One-time payment: ETB {course.price.toLocaleString()}<br/>
                    • Two installments: ETB {Math.ceil(course.price / 2).toLocaleString()} upfront + ETB {Math.ceil(course.price / 2).toLocaleString()} after 4 weeks
                  </p>
                </div>
              </div>
            </div>
